...
void usart1_init(void)
{
	...
	//串口5对应引脚复用映射
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource0,GPIO_AF_UART4); //GPIOC 12 复用为 usart1
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource1,GPIO_AF_UART4); //GPIOD 2 复用为 usart1
  ...
  USART_Init(UART4, &USART_InitStructure); //初始化 usart1
